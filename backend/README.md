...
The API will be available at `https://localhost:5501` or `http://localhost:5500`
...
- Base URL: `http://localhost:5500/api` (or from environment variable `REACT_APP_API_URL`)
