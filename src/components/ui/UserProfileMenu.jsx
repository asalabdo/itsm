...
const UserProfileMenu = () => {
  ...
  const menuItems = [
    ...
    { divider: true },
    { label: 'Sign Out', icon: 'LogOut', action: () => console.log('Logout'), danger: true },
  ];
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-12 w-64 bg-popover border border-border rounded-md shadow-elevation-3 z-dropdown overflow-hidden">
