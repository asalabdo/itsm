    ...
    <div className="h-full flex flex-col bg-card">
      <div className="flex items-center justify-between p-4 md:p-6 border-b border-border">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs md:text-sm text-muted-foreground">{request?.type}</p>
        </div>
        <button
          onClick={onClose}
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-foreground mt-2">{request?.submissionDate}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-foreground mt-2 capitalize">{request?.urgency}</p>
              </div>
