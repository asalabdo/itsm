...
const KnowledgeBaseSection = () => {
  ...
  const categories = [
    ...
    { id: 'getting-started', label: 'Getting Started', icon: 'Rocket', count: 24 },
    { id: 'account', label: 'Account & Billing', icon: 'CreditCard', count: 32 },
    { id: 'technical', label: 'Technical Issues', icon: 'Wrench', count: 45 },
    { id: 'features', label: 'Features & Usage', icon: 'Zap', count: 38 },
    { id: 'security', label: 'Security & Privacy', icon: 'Shield', count: 17 },
  ];
