...
const MyTicketsTable = () => {
  ...
  const tickets = [
    {
      id: 'TKT-4521',
      subject: 'Login issues with mobile app - unable to authenticate',
      status: 'urgent',
      statusLabel: 'Urgent',
      category: 'Incident',
      lastUpdate: '2026-01-06T06:15:00',
      estimatedResolution: '2026-01-06T10:00:00',
      assignedAgent: 'Abdullah Aldosri',
    },
    {
      id: 'TKT-4518',
      ...
      category: 'Incident',
      lastUpdate: '2026-01-06T05:30:00',
      estimatedResolution: '2026-01-06T14:00:00',
      assignedAgent: 'Sarah Alrashedea',
    },
    {
      id: 'TKT-4515',
      subject: 'Request for new feature - dark mode support',
      status: 'in-progress',
      statusLabel: 'In Progress',
      category: 'Change Request',
      lastUpdate: '2026-01-05T16:45:00',
      estimatedResolution: '2026-01-10T17:00:00',
      assignedAgent: 'Abdelrahman Salem',
    },
    {
      id: 'TKT-4512',
      ...
      category: 'Problem',
      lastUpdate: '2026-01-05T14:20:00',
      estimatedResolution: '2026-01-05T14:20:00',
      assignedAgent: 'Abdelrahman Salem',
    },
    {
      id: 'TKT-4509',
      subject: 'Account settings page loading slowly',
      status: 'pending',
      statusLabel: 'Pending',
      category: 'Incident',
      lastUpdate: '2026-01-05T11:00:00',
      estimatedResolution: '2026-01-07T12:00:00',
      assignedAgent: 'Sarah Alrashedea',
    },
    {
      id: 'TKT-4506',
      ...
      statusLabel: 'Closed',
      category: 'Problem',
      lastUpdate: '2026-01-04T09:30:00',
      estimatedResolution: '2026-01-04T09:30:00',
      assignedAgent: 'Abdullah Aldosri',
    },
  ];
          ...
          <tbody>
            {filteredTickets?.map((ticket) => (
              ...
              >
                ...
                <td className="py-4 px-4">
                  <span className="text-foreground line-clamp-2">{ticket?.subject}</span>
                </td>
                <td className="py-4 px-4">
                ...
                <td className="py-4 px-4">
                  <span className="text-sm text-muted-foreground caption">{formatDateTime(ticket?.lastUpdate)}</span>
                </td>
                <td className="py-4 px-4">
                  <span className="text-sm text-muted-foreground caption">
                    {new Date(ticket.estimatedResolution)?.toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                  </span>
                </td>
                <td className="py-4 px-4">
          ...
          >
            ...
            <div className="flex items-center justify-between pt-3 border-t border-border">
              <span className="text-xs text-muted-foreground caption">
                Est. {new Date(ticket.estimatedResolution)?.toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
              </span>
