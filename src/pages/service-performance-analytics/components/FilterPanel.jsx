...
const FilterPanel = ({ onFiltersChange, onExport, lastUpdated }) => {
  ...
  const timeRangeOptions = [
    ...
    { value: 'q1', label: 'الربع الأول 2024' },
    { value: 'q2', label: 'الربع الثاني 2024' },
    { value: 'q3', label: 'الربع الثالث 2024' },
    { value: 'yearly', label: 'عام 2024' }
  ];

  const departmentOptions = [
    { value: 'all', label: 'كل الأقسام' },
    { value: 'it', label: 'خدمات تقنية المعلومات' },
    { value: 'hr', label: 'الموارد البشرية' },
    { value: 'finance', label: 'المالية' },
    { value: 'operations', label: 'العمليات' },
    { value: 'sales', label: 'المبيعات والتسويق' }
  ];

  const serviceOptions = [
    { value: 'all', label: 'كل الخدمات' },
    { value: 'incident', label: 'إدارة الحوادث' },
    { value: 'request', label: 'طلبات الخدمة' },
    { value: 'change', label: 'إدارة التغيير' },
    { value: 'problem', label: 'إدارة المشاكل' },
    { value: 'asset', label: 'إدارة الأصول' }
  ];
    ...
    <div className="bg-card border border-border rounded-lg p-6 mb-6 operations-shadow">
      ...
      <div className="mt-4 pt-4 border-t border-border">
        <div className="flex items-center justify-between text-sm text-muted-foreground">
          <span>{t('lastUpdated', 'Last updated')}: {lastUpdated ? new Date(lastUpdated).toLocaleString() : '—'}</span>
          <div className="flex items-center space-x-2">
