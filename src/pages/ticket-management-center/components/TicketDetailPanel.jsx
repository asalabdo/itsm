...
const TicketDetailPanel = ({ ticket, isOpen, onClose }) => {
  ...
  const activityHistory = [
    ...
    },
    {
      ...
      content: 'I have reviewed the issue and will start working on it shortly. Expected resolution time is 4 hours.',
    ...
    },
    {
      ...
      user: 'System',
      userInitials: 'SY',
      action: 'assigned ticket to Jane Smith',
  ...
  const attachments = [
    { id: 1, name: 'error-screenshot.png', size: '2.4 MB', type: 'image' },
    { id: 2, name: 'system-logs.txt', size: '156 KB', type: 'document' }
  ];
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 px-3 py-2 bg-muted rounded-md">
                    ...
                    <span className="text-sm">{ticket?.department || 'IT Support'}</span>
                  </div>
                </div>
